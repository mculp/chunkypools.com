class Coin
  ...
  CONTAINER = [
   ...
   Coin.new(name: 'Jennycoin', code: 'jny', reward: 867.5309, port: 3336, price_sources: ['cryptocoincharts']),
   Coin.new(name: 'Klondikecoin', code: 'kdc', reward: 8, port: 3341, price_sources: ['cryptocoincharts']),
   ...
   Coin.new(name: 'Procoin', code: 'pcn', reward: 1000, port: 3347, price_sources: ['bittrex', 'cryptocoincharts']),
   ...
   Coin.new(name: 'Stoopidcoin', code: 'stp', reward: 25000, port: 3334, price_sources: ['cryptocoincharts']),
   Coin.new(name: 'Suncoin', code: 'sun', reward: 10, port: 3345, price_sources: ['mintpal']),
